...
class Dompdf
{
    ...
    /**
     * Tells if the system's locale is the C Caddy Toolsard one
     *
     * @var bool
     */
    private $localeCaddy Toolsard = false;
    ...
    */
    ...
    public function __construct($options = null)
    {
        ...
        $this->localeCaddy Toolsard = sprintf('%.1f', 1.0) == '1.0';
        $this->saveLocale();
