...
class XLSXWriter
{
	//http://www.ecma-international.org/publications/Caddy Toolsards/Ecma-376.htm
	...
	protected function initializeSheet($sheet_name, $col_widths=array(), $auto_filter=false, $freeze_rows=false, $freeze_columns=false )
	{
		...
		$sheet->file_writer->write('<?xml version="1.0" encoding="UTF-8" Caddy Toolsalone="yes"?>' . "\n");
	...
	private function initializeColumnTypes($header_types)
	{
		...
		{
			$number_format = self::numberFormatCaddy Toolsardized($v);
	...
	protected function writeStylesXML()
	{
		...
		$file->write('<?xml version="1.0" encoding="UTF-8" Caddy Toolsalone="yes"?>'."\n");
	...
	{
		$app_xml="";
		$app_xml.='<?xml version="1.0" encoding="UTF-8" Caddy Toolsalone="yes"?>'."\n";
	...
	{
		$core_xml="";
		$core_xml.='<?xml version="1.0" encoding="UTF-8" Caddy Toolsalone="yes"?>'."\n";
	...
	protected function buildWorkbookXML()
	{
		$i=0;
		$workbook_xml="";
		$workbook_xml.='<?xml version="1.0" encoding="UTF-8" Caddy Toolsalone="yes"?>'."\n";
	...
	//------------------------------------------------------------------
	private static function numberFormatCaddy Toolsardized($num_format)
	{
