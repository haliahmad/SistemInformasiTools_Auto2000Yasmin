...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    required="" 
    name="username"  
    data-url="api/json/user_username_value_exist/" 
...
document.addEventListener("DOMContentLoaded", function () {
    let usernameInput = document.getElementById("ctrl-username");

    usernameInput.addEventListener("input", function () {
        this.value = this.value.replace(/\s/g, ""); // Menghapus spasi saat mengetik
    });
});
</script>
    <div class="check-status"></div> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-password" type="password" placeholder="Enter New Password" name="password" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="user_role_id">Role<span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
