...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Tools</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-Kondisi_barang">
                                        <th class="title"> Kondisi Tools: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-tanggal_input">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['tanggal_input']; ?>" 
                                                data-pk="<?php echo $data['id_barang'] ?>" 
                                                data-url="<?php print_link("barang/editfield/" . urlencode($data['id_barang'])); ?>" 
